...
@section('content')
    ...
    <section class="structure-user-create formed-page">
      ...
      <form id="update_profile" action="/store_user" method="POST" enctype="multipart/form-data">
         ...
         <div class="input-container-inline">
            <label for="nickname">{{__('Ник')}}. {{__('Вступает в качестве логина')}}!</label>
            <input 
               id="nickname" 
               name="nickname" 
               type="text"
         ...
         <div class="input-container-inline">
            <label for="birth_date">{{__('День рождения')}}</label>
            <input 
               id="birth_date" 
               type="date" 
               name="birth_date"
         ...
         <div class="input-container-inline">
            <label for="email">E-mail. {{__('На эту почту будет отправлено')}}<br> {{__('письмо с логином и паролем пользователя')}}!</label>
            <input 
               id="email" 
               name="email" 
               type="text"
         ...
         <div class="input-container-inline">
            <label for="dep-name">{{__('Отдел')}}</label>
            {{-- department start --}}
         ...
         <div class="input-container-inline">
            <label for="designation">{{__('Позиция')}}</label>
            {{-- designation start --}}

...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $txts = ['Привет, акаи Бобур!', 'Добрый день, Икром', 'Мне нужна ваша помощь ака', 'Слушаю??', 'Так как меня не было вчера я не получил свои задачки. У вас же они есть можете мне отправить?', 'Хорошо я тебе отправлю', 'Спасибо, вы лучший!', 'Кто бы сомневался!'];
        //chat

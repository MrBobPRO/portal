...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $prText = [
                    'В разные годы на Нурекской ГЭС, специалистами нашей компании, были произведены строительные и электромонтажные работы различных объёмов, в том числе: монтаж трансформаторов, строительство ОРУ 500/220 кВ, прокладка силовых, контрольных и оптоволоконных кабелей.

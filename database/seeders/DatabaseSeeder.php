...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $imageUrls = ['news.jpg', 'lion.jpg', 'doit.jpg', 'wolf.jpg'];
        $titles = ['Is Pizza better than Qurutob?', 'He was seen after', 'We need seniors', 'Who stole my mood?'];
        $texts = [
            'Мы ускоряем бизнес-процессы, заменяя отношение сотрудников к работе с «я должен, ну ладно, сделаю» на «я хочу и сделаю это лучше всех». «Пряники»Мы ускоряем бизнес-процессы, заменяя отношение сотрудников к работе с «я должен, ну ладно, сделаю» на «я хочу и сделаю это лучше всех». «Пряники» – это проекты полного цикла по улучшению внутренних коммуникаций, прокачке KPI, организации работы с идеями и ускорению других бизнес-процессов за счет повышения мотивации сотрудников.',
